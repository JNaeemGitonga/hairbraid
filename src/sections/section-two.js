...
const SectionTwo = () => (
    <div id="about-us" className="container-two about-us">
        ...
        <div className="box-blue" data-aos="fade-right">
            <p>
            HERBRAIDQUEEN offers affordable, tension less, protective styles that 
            last at least 6 weeks. Based in Atlanta, GA, Herbraidqueen aims to 
            provide the upmost quality service that leave clients more than satisfied. 
            Herbraidqueen specializes in braids making sure to treat each client 
            individually and with the upmost care best for their hair needs. 
